...
class Ui_AppWindow(object):
    def setupUi(self, AppWindow):
        ...
        self.btn_calculate.setGeometry(QtCore.QRect(102, 600, 180, 40))
        font = QtGui.QFont()
        ...
        self.btn_reset_tasks.setGeometry(QtCore.QRect(487, 600, 180, 40))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        ...
        self.frame_questions.setGeometry(QtCore.QRect(5, 167, 750, 400))
        ...
        self.treeWidget.setGeometry(QtCore.QRect(5, 5, 745, 360))
