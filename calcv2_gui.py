...
class Ui_AppWindow(object):
    def setupUi(self, AppWindow):
        ...
        self.btn_report_ugt = QtWidgets.QPushButton(self.frame_tprl_results)
        self.btn_report_ugt.setGeometry(QtCore.QRect(480, 310, 180, 30))
        self.btn_report_ugt.setObjectName("btn_report_ugt")

        # ----------------------Вкладка оценки рисков-----------------------------
        self.tab_risks = QtWidgets.QWidget()
        self.tab_risks.setObjectName("tab_risks")
        self.tabWidget.addTab(self.tab_risks, "")
        self.frame_risks = QtWidgets.QFrame(self.tab_risks)
        self.frame_risks.setGeometry(QtCore.QRect(0, 0, 820, 580))
        ...
        self.risks_labelProject.setAlignment(QtCore.Qt.AlignLeading | QtCore.Qt.AlignLeft | QtCore.Qt.AlignVCenter)
        self.risks_labelProject.setObjectName("risks_labelProject")

        self.risks_label_expert = QtWidgets.QLabel(self.frame_risks)
        self.risks_label_expert.setGeometry(QtCore.QRect(10, 45, 80, 30))
        ...
        self.risks_label_project_num.setGeometry(QtCore.QRect(150, 10, 200, 30))
        self.risks_label_project_num.setFont(font)
        self.risks_label_project_num.setObjectName("label_project_num")

        self.risks_label_expert_name = QtWidgets.QLabel(self.frame_risks)
        self.risks_label_expert_name.setGeometry(QtCore.QRect(95, 45, 290, 30))
        self.risks_label_expert_name.setFont(font)
        self.risks_label_expert_name.setText("")
        ...
        self.risk_param_tabs.move(0, 80)
        self.risk_param_tabs.setMinimumWidth(815)
        self.risk_param_tabs.setMaximumWidth(815)
        self.risk_param_tabs.setMaximumHeight(250)
    ...
    def retranslateUi(self, AppWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_risks), _translate("AppWindow", "Оценка рисков"))
        ...
        self.btn_report_ugt.setText(_translate("AppWindow", "Создать заключение"))
        self.btn_report_risks.setText(_translate("AppWindow", "Создать заключение"))
        self.risks_labelProject.setText(_translate("AppWindow", "Номер проекта:"))
        self.risks_label_expert.setText(_translate("AppWindow", "Эксперт:"))
