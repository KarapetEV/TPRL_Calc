...
class Window(QWidget, calc_gui.Ui_AppWindow):
    ...
    def create_risk_table(self):
        ...
        self.risks_table.setColumnWidth(1, 540)
        self.risks_table.setColumnWidth(2, 110)

        for i in range(rows):
            self.risks_table.setCellWidget(i, 0, QLabel(self.word_wrap(risk_group[i], 26)))
            self.risks_table.setCellWidget(i, 1, QLabel(self.word_wrap(risk_text[i], 90)))
