...
class ReportRisks:
    def __init__(self, data, tab, tprl_risk_list):
        ...
        self.title = ["Экспертное заключение № ____",
                       "по оценке рисков недостижения уровня готовности",
                       "инновационных проектов в ОАО «РЖД» с их применением",
                       "через соответствующие уровни готовности"]
        self.text = ['1.    Дата проведения экспертного оценивания: ',
                     '2.    Идентификационный номер проекта: ',
                     '3.    ФИО эксперта: ',
                     '4.    Тип параметра: '
                     ]
        self.table_title = '5.    Оценка рисков недостижения уровней готовности по параметрам:'
        self.final_tprl_risk_text = '6.    Итоговая оценка риска недостижения заданного уровня зрелости ' \
