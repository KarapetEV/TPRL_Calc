...
class Ui_AppWindow(object):
    def setupUi(self, AppWindow):
        ...
        self.labelProject.setGeometry(QtCore.QRect(10, 10, 125, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_project_num.setGeometry(QtCore.QRect(145, 10, 200, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_expert.setGeometry(QtCore.QRect(10, 45, 70, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_expert_name.setGeometry(QtCore.QRect(90, 45, 300, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
